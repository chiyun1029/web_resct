...
export const SET_CAR_MOVING = `${KEY_REDUCER}/SET_CAR_MOVING`;
...
export const SET_MAP_DISABLED = `${KEY_REDUCER}/SET_MAP_DISABLED`;
export const SET_SNAKE_SPEED_MODIFIED = `${KEY_REDUCER}/SET_SNAKE_SPEED_MODIFIED`;

export const GAME_WIDTH_SIZE = '80vw';
export const GAME_HEIGHT_SIZE = 'calc(1 / 1 * 80vw)';
export const GAME_WIDTH = 146;
export const GAME_HEIGHT = 146;
